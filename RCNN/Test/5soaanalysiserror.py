...
POdir='F:/DataRCNN/Test/confusion/5/normal/PO'
CIdir='F:/DataRCNN/Test/time/5/normal/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/5/normal'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/0_ST050N2H0_Rampe100-130_Standard/data.csv'
pred = error(BS, 'normal/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'5normal.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/5/ESM/PO'
CIdir='F:/DataRCNN/Test/time/5/ESM/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/5/ESM'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/1_ST050N2H0_Rampe100-130_ESM+0.5/data.csv'
pred = error(BS, 'ESM/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'5ESM.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/5/140/PO'
CIdir='F:/DataRCNN/Test/time/5/140/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/5/140'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/3_ST050N2H0_Rampe100-130_Pq140/data.csv'
pred = error(BS, '140/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'5140.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/5/strahl/PO'
CIdir='F:/DataRCNN/Test/time/5/strahl/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/5/strahl'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/4_ST050N2H0_Rampe100-130_Strahlaußermittigkeit/data.csv'
pred = error(BS, 'strahl/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'5strahl.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/5/70/PO'
POdir='F:/DataRCNN/Test/time/5/70/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/5/70'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/2_ST050N2H0_Rampe100-130_Pq70/data.csv'
pred = error(BS, '70/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'570.png',posCI, listeSOA)
