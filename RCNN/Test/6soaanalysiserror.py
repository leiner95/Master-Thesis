...
POdir='F:/DataRCNN/Test/confusion/6/normal/PO'
CIdir= 'F:/DataRCNN/Test/time/6/normal/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/6/normal'
datadir= 'F:/Test_Sequenzen/ST060-N2H0/0_ST060N2H0_Rampe100-130_Standard/data.csv'
pred = error(BS, 'normal/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'6normal.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/6/ESM/PO'
CIdir='F:/DataRCNN/Test/time/6/ESM/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/6/ESM'
datadir= 'F:/Test_Sequenzen/ST060-N2H0/1_ST060N2H0_Rampe100-130_ESM+0.5/data.csv'
pred = error(BS, 'ESM/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'6ESM.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/6/140/PO'
CIdir='F:/DataRCNN/Test/time/6/140/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/6/140'
datadir= 'F:/Test_Sequenzen/ST060-N2H0/3_ST060N2H0_Rampe100-130_Pq140/data.csv'
pred = error(BS, '140/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'6140.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/6/strahl/PO'
CIdir='F:/DataRCNN/Test/time/6/strahl/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/6/strahl'
datadir= 'F:/Test_Sequenzen/ST060-N2H0/4_ST060N2H0_Rampe100-130_Strahlaußermittigkeit/data.csv'
pred = error(BS, 'strahl/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'6strahl.png',posCI, listeSOA)

POdir='F:/DataRCNN/Test/confusion/6/70/PO'
CIdir='F:/DataRCNN/Test/time/6/70/CI'
BS=len(os.listdir(CIdir)) + len(os.listdir(POdir))-5
posCI=len(os.listdir(POdir))
soatest_dir = 'F:/DataCNN/Test/confusion/6/70'
datadir= 'F:/Test_Sequenzen/ST060-N2H0/2_ST060N2H0_Rampe100-130_Pq70/data.csv'
pred = error(BS, '70/{classname}/*.avi', model)
listeSOA= SOA(datadir, soatest_dir)
eim(pred,'670.png',posCI, listeSOA)
