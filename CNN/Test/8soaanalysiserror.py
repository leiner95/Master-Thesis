...
POdir='F:/DataCNN/Test/time/8/70/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/8/70'
...
POdir='F:/DataCNN/Test/time/8/ESM/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/8/ESM'
