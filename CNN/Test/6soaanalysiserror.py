...
POdir='F:/DataCNN/Test/time/6/70/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/6/70'
...
POdir='F:/DataCNN/Test/6/ESM/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/6/ESM'
