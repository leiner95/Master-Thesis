...
POdir='F:/DataCNN/Test/time/5/70/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/5/70'
...
eim(pred,'m570.png',posCI, listeSOA)

POdir='F:/DataCNN/Test/time/5/140/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/5/140'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/3_ST050N2H0_Rampe100-130_Pq140/data.csv'
pred = error(model, test_dir)
listeSOA= SOA(datadir, test_dir)
eim(pred,'m5140.png',posCI, listeSOA)

POdir='F:/DataCNN/Test/time/5/normal/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/5/normal'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/0_ST050N2H0_Rampe100-130_Standard/data.csv'
pred = error(model, test_dir)
listeSOA= SOA(datadir, test_dir)
eim(pred,'m5normal.png',posCI, listeSOA)

POdir='F:/DataCNN/Test/time/5/strahl/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/5/strahl'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/4_ST050N2H0_Rampe100-130_Strahlaußermittigkeit/data.csv'
pred = error(model, test_dir)
listeSOA= SOA(datadir, test_dir)
eim(pred,'m5strahl.png',posCI, listeSOA)

POdir='F:/DataCNN/Test/time/5/ESM/PO'
posCI=len(os.listdir(POdir))
test_dir = 'F:/DataCNN/Test/time/5/ESM'
datadir= 'F:/Test_Sequenzen/ST050-N2H0/1_ST050N2H0_Rampe100-130_ESM+0.5/data.csv'
pred = error(model, test_dir)
listeSOA= SOA(datadir, test_dir)
eim(pred,'m5ESM.png',posCI, listeSOA)
